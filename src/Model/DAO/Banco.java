...
public class Banco {
    ...
    public static void inicia(){
        ...
        Cliente cliente1 = new Cliente(1, " Vitor Igor", 'M', "30/01/1995", "30212126", "vittorigor.honorio@gmail.com", "5142487", "Rua jaboti 35 Canudos NH",  "93300012");
        Cliente cliente2 = new Cliente(2, "Mario Oliveira", 'F', "30/08/1994", "30212127", "mariooliveirapet@gmail.com", "5142487745", "Rua campo bom 78 Centro NH",  "93300045");
        ...
        Cliente cliente4 = new Cliente(4, "Matheus Santos", 'M', "20/08/1995", "30212130", "matheussantospet@gmail.com", "2745487", "Rua Lombardi 40 Canudos NH",  "93300748");
        ...
        Cliente cliente6 = new Cliente(6, "Vinicius Pareira", 'M', "17/08/1994", "302122324", "vivnicuis@gmail.com", "78512457", "Rua champions 10 Kephas Franca",  "933000782");
        Cliente cliente7 = new Cliente(7, "Marcelo de Souza", 'F', "25/03/1993", "302121292", "marcelosouzapet@gmail.com", "4658237314", "Rua tesla 215 Canudos NH",  "93352012");
        Cliente cliente8 = new Cliente(8, "Alice Ferrari", 'F', "04/03/1990", "302121451", "alineferraripet@gmail.com", "8475123687", "Rua hyrule 32 Canudos NH",  "9334714747");
        Cliente cliente9 = new Cliente(9, "Santos Coltinho", 'M', "09/02/1998", "302121189", "santoscoltinhopet@gmail.com", "74595142487", "Rua floresta 12 Canudos NH",  "9330046364");
        ...
        Agendamento agendamento1 = new Agendamento(1, cliente1, servico2, 30, "19/11/2021 17:00");
        Agendamento agendamento2 = new Agendamento(2, cliente3, servico4, 40, "20/12/2021 10:00");
        Agendamento agendamento3 = new Agendamento(3, cliente4, servico1, 18, "23/11/2021 10:30");
        Agendamento agendamento4 = new Agendamento(4, cliente2, servico2, 30, "19/11/2021 17:00");
        Agendamento agendamento5 = new Agendamento(5, cliente7, servico4, 40, "20/12/2021 10:00");
        Agendamento agendamento6 = new Agendamento(6, cliente8, servico1, 18, "23/11/2021 10:30");
